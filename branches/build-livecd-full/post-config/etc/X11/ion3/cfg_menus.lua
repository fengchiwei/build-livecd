...
defmenu("adminmenu", {
    menuentry("文書處理 (openoffice)",          "ioncore.exec_on(_, 'openoffice')"),
...
-- Admin application menu
defmenu("settingmenu", {
    menuentry("ADSL (pppoeconf)",          "ioncore.exec_on(_, 'sudo pppoeconf')"),
    menuentry("網路卡設定 (netcardconfig)",          "ioncore.exec_on(_, 'sudo netcardconfig')"),
    ...
    menuentry("印表機 (foomatic-gui)", "ioncore.exec_on(_, 'sudo foomatic-gui')"),
    menuentry("防火牆 (firestarter)", "ioncore.exec_on(_, 'sudo firestarter')"),
})
