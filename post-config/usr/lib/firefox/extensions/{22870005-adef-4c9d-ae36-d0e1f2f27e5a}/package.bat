@ rem ---------------------------------------------------------------------------------------------------
@ rem This is dos-batch file,  used to repackage the extension.
@ rem ---------------------------------------------------------------------------------------------------
...
@cd ..
del %ProjectName%.xpi *.xpi
zip -r %ProjectName%.xpi . -x CVS %ProjectName%.xpi package.bat package.sh readme.txt update.xml *.xpi
