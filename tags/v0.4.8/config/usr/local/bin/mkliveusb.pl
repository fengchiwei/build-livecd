#!/usr/bin/perl
# mkliveusb.pl - PUD GNU/Linux LiveUSB Installer
...
on_cancel_clicked 	=> sub { Gtk2->main_quit },
on_makesure_clicked 	=> \&on_makesure_clicked,
on_button8_clicked 	=> sub { Gtk2->main_quit },
on_button8_destroy 	=> sub { Gtk2->main_quit },
on_errchk_clicked 	=> sub { $gladexml->get_widget('dialog3')->hide },
on_back_clicked 	=> sub {
				$gladexml->get_widget('dialog2')->hide;
				$gladexml->get_widget('dialog1')->show; },
on_goback_clicked 	=> sub {
