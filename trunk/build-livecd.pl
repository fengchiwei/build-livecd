...
&do_chroot('mv /etc/rc2.d/S99rc.local /etc/rc2.d/S95rc.local');
&do_chroot('mv /etc/rc2.d/S98usplash /etc/rc2.d/S99usplash');
&do_chroot('ln -s ../init.d/auto_mount /etc/rc2.d/S96auto_mount');
&do_chroot('ln -s ../init.d/load-opt /etc/rc2.d/S97load-opt');
&do_chroot('ln -s ../init.d/pudata /etc/rc2.d/S98pudata');
